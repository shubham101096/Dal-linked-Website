    ...
    <div className="App">
      ...
      <Router>
        <Routes>
            ...
            {/* LOGIN / SIGNUP */}
            <Route path="/login-signup" element={!user ? <LoginSignUpPage /> : <Navigate to="/test-student"/>} />
            {/* REGISTRATION ROUTES */}
            <Route path="/registration-student" element={!user ? <RegistrationFormStudent /> : <Navigate to="/test-student"/>} />
            <Route path="/registration-employer" element={!user ? <RegistrationFormEmployer /> : <Navigate to="/" />} />

            {/* LOGIN ROUTES */}
            <Route path="/login-student" element={!user ? <LogInStudent /> : <Navigate to="/test-student" />} />
            <Route path="/login-employer" element={!user ? <LogInEmployer />  : <Navigate to="/" /> } />
            <Route path="/login-admin" element={!user ? <LogInAdmin /> : <Navigate to="/" />} />
